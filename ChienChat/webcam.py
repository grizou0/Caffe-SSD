...
job_name = "".format(resize)
# The name of the model. Modify it if you want.
model_name = "VGG_VOCdevkit_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "examples/ChienChat/{}_webcam".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "examples/ChienChat/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ChienChat{}_webcam".format(job_name)
